...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(327, 50));
    ...
    public void Register(){
        try{  
            ...
            ResultSet rs=stmt.executeQuery("select count(*) as cnt from userlogin");  
            int count=0;
            while(rs.next())
                count=rs.getInt("cnt");
            
            if(password.equals(cpassword)){
            String qre = "insert into userlogin(username,password,email) values('" + username + "','" + password + "','"+email+"')";  
            stmt.executeUpdate(qre);
            System.out.println("connected");
            }else{
                jLabel6.setText("password & confirm password doesn't match!");
            }
            con.close();  
            }catch(SQLException se){ //System.out.println(e);
            se.printStackTrace();
            }catch(Exception e){
                e.printStackTrace();
            } 
